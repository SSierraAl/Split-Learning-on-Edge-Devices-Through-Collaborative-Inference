...
// g++ Red_Split_nodo_2.cpp -o Neural_Split2
//Código para cguardar la salida en un archivo .txt
// ./Neural_Split2 > Neural_Split2.txt  
//---------------------------------------------------------
...
int main()
{
    TrainingData trainData("/tmp/TdataOR_split_2.txt");
    cout <<  "Pasasamos " << endl;
    // topologia de la red
    ...
    trainData.WeightData("/tmp/pesos_split_2.txt");
